...
&& az rest --method put --url "https://management.azure.com/$0/providers/Microsoft.Chaos/targets/Microsoft-AzureKubernetesServiceChaosMesh/capabilities/NetworkChaos-2.1?api-version=2021-09-15-preview"  --body "{\"properties\":{}}"'
